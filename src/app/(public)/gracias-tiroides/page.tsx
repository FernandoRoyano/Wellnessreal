...
export const metadata: Metadata = {
  title: 'Descarga tu Guía de Tiroides | WellnessReal',
  description: 'Descarga tu guía gratuita para entrenar y adelgazar con hipotiroidismo.',
...
export default function GraciasTiroidesPage() {
  return (
    <>
        ...
        <Container>
          <div className="relative max-w-3xl mx-auto text-center space-y-6">
            ...
            <p className="text-fluid-xl text-white/85 font-medium">
              Descárgala ahora y entiende por fin qué le pasa a tu metabolismo.
            </p>
