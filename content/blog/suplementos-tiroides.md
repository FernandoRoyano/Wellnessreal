...
![Comparativa visual de yodo, selenio, vitamina D, hierro y aceleradores del metabolismo según su utilidad y precauciones](/blog/suplementos-tiroides-mapa.png)
...
En personas susceptibles —especialmente con enfermedad tiroidea autoinmune— un exceso de yodo puede alterar la función tiroidea e incluso empeorar el hipotiroidismo. El [NIDDK](https://www.niddk.nih.gov/health-information/endocrine-diseases/hashimotos-disease) advierte específicamente de los suplementos de yodo y de productos con grandes cantidades, como algunas algas. La [American Thyroid Association](https://www.thyroid.org/ata-statement-on-the-potential-risks-of-excess-iodine-ingestion-and-exposure/) también desaconseja los suplementos con dosis elevadas sin supervisión.

Esto **no significa que debas eliminar el yodo normal de tu alimentación**. Significa que no conviene comprar gotas, algas kelp o complejos “thyroid support” por tu cuenta. Embarazo, lactancia y déficit confirmado son contextos distintos y necesitan una valoración individual.

![Diagrama que explica que la tiroides necesita yodo, pero que tanto el déficit como el exceso pueden causar problemas](/blog/suplementos-tiroides-yodo.png)

## Selenio: resultados interesantes, pero no una solución mágica

El selenio participa en procesos importantes para la tiroides y es el suplemento que suele aparecer con una base científica más razonable. Una [revisión sistemática y metaanálisis de 2024](https://pmc.ncbi.nlm.nih.gov/articles/PMC10951571/) encontró reducciones en TSH en determinados pacientes sin tratamiento hormonal y en anticuerpos TPO. Sin embargo, no observó cambios significativos en varias hormonas tiroideas ni en el volumen de la glándula.
...
## “Aceleradores del metabolismo” y complejos thyroid support
...
1. ¿Qué ingrediente produce exactamente ese efecto?
2. ¿La dosis aparece claramente en la etiqueta?
3. ¿Hay estudios en personas con mi situación, no solo en células o animales?
4. ¿Puede interferir con mi medicación?
5. ¿Lo tomaría igualmente si el envase no dijera “natural”?
...
1. **Aclara el objetivo.** No es lo mismo corregir una carencia que intentar adelgazar.
2. **Revisa analíticas y tratamiento.** Los síntomas por sí solos no identifican qué nutriente falta.
3. **Comprueba dosis e interacciones.** “Natural” no significa inocuo.
4. **Decide con tu médico o endocrino.** Especialmente con yodo, hierro, embarazo o medicación tiroidea.
5. **Evalúa el resultado.** Si se pauta algo, debe existir un motivo y una forma de comprobar si está funcionando.
